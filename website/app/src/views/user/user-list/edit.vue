    ...
    <el-card style="width: 100%; margin-top: 20px">
      ...
      <el-form :model="form" inline label-width="80px">
        ...
        <el-form-item label="用户名">
          <el-input :disabled="false" v-model="form.username" style="width: 200px" autocomplete="off" />
        </el-form-item>
        ...
        <el-form-item label="性别">
          <el-select :disabled="false" style="width: 150px" v-model="form.gender" placeholder="请选择性别">
        ...
        <el-form-item label="出生日期">
          <el-date-picker :disabled="false" style="width: 150px" v-model="form.birthday" type="date" placeholder="选择日期" />
        </el-form-item>
        <el-form-item label="电话号码">
          <el-input :disabled="false" type="" v-model="form.phone" style="width: 200px" autocomplete="off" />
        </el-form-item>
      ...
      <el-button :disabled="false" type="primary" style="float: right;margin: 10px 50px 20px 0" @click="submit">确认编辑</el-button>
    </el-card>
