    ...
    <el-card style="width: 100%; margin-top: 20px">
      ...
      <el-form :model="form" inline label-width="80px">
        ...
        <el-form-item label="商品ID">
          <el-input :disabled="false" v-model="form._id" style="width: 200px" autocomplete="off" />

        </el-form-item>
        <el-form-item v-if="form.user" label="发布者">
          <el-input :disabled="false" v-model="form.user.username" style="width: 200px" autocomplete="off" />
        </el-form-item>
        <el-form-item v-if="form.user"  label="发布者id">
          <el-input :disabled="false" v-model="form.user._id" style="width: 200px" autocomplete="off" />
        </el-form-item>
        <el-form-item label="发布时间">
          <el-date-picker :disabled="false" style="width: 150px" v-model="form.created" type="date" placeholder="选择日期" />
        </el-form-item>
        <el-form-item label="校区">
          <el-select :disabled="false" style="width: 150px" v-model="form.campus" placeholder="请选择校区">
            <el-option v-for="item in  [...campusOptions].splice(1, 4)" :key="item.label" :value="item.value" :label="item.label"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="商品原价">
          <el-input :disabled="false" v-model="form.origin_price" style="width: 200px" autocomplete="off" />
        </el-form-item>
        <el-form-item label="商品价格">
          <el-input :disabled="false" v-model="form.price" style="width: 200px" autocomplete="off" />
        </el-form-item>
        <el-form-item label="商品标题">
          <el-input :disabled="false" v-model="form.title" style="width: 200px" autocomplete="off" />
        </el-form-item>
        <el-form-item label="商品介绍">
          <el-input :disabled="false" v-model="form.desc"
                    :rows="4"
                    :max="300"
      ...
      <el-button type="primary" style="float: right;margin: 10px 50px 20px 0" @click="submit">确认编辑</el-button>
    </el-card>
